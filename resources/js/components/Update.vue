  ...
  <loading-view :loading="loading">
    ...
    >
      ...
      <div class="flex items-center">
        ...
        <progress-button
          class="mr-3"
          dusk="previous-button"
          :disabled="isWorking || wizardFirst"
          :processing="false" 
        ...
        <progress-button
          class="mr-3"
          dusk="next-button" 
          :disabled="isWorking || wizardDone"
          :processing="wasValidatedResource" 
          @click.native="validateViaUpdateResourceAndContinueEditing"
        >
          {{ __('Next') }}
        </progress-button>
...
export default {
  mixins: [InteractsWithResourceInformation, Wizard],
  ...
  methods: {
    ...
    validateRequest(step) {
      return Nova.request().post(
        `/nova-vendor/wizard/${this.resourceName}/${this.resourceId}`,
        this.validateResourceFormData,
        {
          params: {
            viaResource: this.viaResource,
            viaResourceId: this.viaResourceId,
